...
import { AnswerFactory } from 'test/factories/make-answers.factory'
...
describe('Comment on answer (E2E)', () => {
  ...
  test('[POST] /answers/:answerId/comments', async () => {
    ...
    expect(commentsOnDatabase).toBeTruthy()
    expect(commentsOnDatabase?.content).toBe('this is a comment')
  })
})
